...
export default function TikTokFollowersList({ followers }: TikTokFollowersListProps) {
  ...
  return (
    <div>
      ...
      Last updated: January 23, 2026 12:00am ET. The gems are given to OGs who commented before the cutoff. Note: I had to stop monitoring comments on older videos as there were thousands.
      </p>
